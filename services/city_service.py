...
def get_weather_data(locations = global_locations):
  loc_dicts = process_queue([f'https://www.metaweather.com/api/location/{loc}/' for loc in locations])
  data = []
  for i in loc_dicts:
    cw = i['consolidated_weather']
    lst = [abr['weather_state_abbr'] for abr in cw]
